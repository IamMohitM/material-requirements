...
├── CODEX.md                           # This file - project context and guidelines
...
- `/README.md` - Getting started guide ✅
- `CODEX.md` - Project context and guidelines ✅
...
For complex development tasks that require coordination between different experts, use the **Software Orchestrator** skill via Codex.
...
- This CODEX.md for project context
